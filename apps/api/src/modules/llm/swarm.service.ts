...
/**
 * The Swarm orchestrates multi-agent LLM workflows.
 *
 * Phase 1 — Planning:
...
export class ExecutionOrchestratorService {
  ...
  async code(
    ...
    this.logger.log(`Swarm coding: ${plan.tasks.length} parallel coder agents`);
    ...
    this.logger.log(`Swarm coding complete: ${changes.length} files generated`);
